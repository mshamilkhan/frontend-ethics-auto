...
<div class="contact-us">
    ...
    <div class="container pt10">
        <div class="row">
            <div class="col-12 mt-5 text-center"> <h1>Contact Us</h1>
...
<section class="mt-5">
 ...
 <div class="contact-form text-center pt-4 pl-4 pr-4 "> 
        ...
        <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Fusce porttitor orci id lorem volutpat.</p>
        ...
        <form class=""  method="POST" id="quoteForm" autocomplete="off">
                            ...
                            <div class="group-form">
                                <textarea cols="30" rows="5" name="quote[message]" placeholder="Comment"
                                    class="form-controls mb-2"></textarea>
                            </div>
