...
<div class="top-bar pt-2 pb-2">
        <div class="container">
            <div class="row">
                <div class="col-6 ">
                    <img src="images/phone.png" alt=""> <span> +543 5689334 | +044 5689334</span> 
                </div>
                <div class="col-6 ">
                    <img src="images/mail.png" alt=""> <span> ethicsauto@gmail.com | loremipsum@example.com </span> 
                </div>
            </div>
        </div>
    </div>
                ...
                <div class="container">
                    <div class="row ">
                        <div class="col-lg-2 col-6">
                            <div class="logo">
                                <a href="index.php">
                               <img src="images/logow.png" class="imgFluid" alt="">
                                </a>
                            </div>
                        </div>
                        <div class="col-lg-10 col-6 d-none">
                            <div class="open-nav">
